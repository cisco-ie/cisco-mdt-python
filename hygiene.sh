...
echo "Running black ..."
FORMAT_COMMAND="black --safe --verbose --exclude proto src/cisco_mdt"
...
pipenv run pylint --disable no-member --disable wrong-import-position --disable bad-continuation src/cisco_mdt/*.py
